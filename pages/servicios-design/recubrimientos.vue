...
export default {
  ...
  head() {
    if (!this.service) {
      return {
        title: 'Recubrimientos | OMA - Servicios de Manufactura',
        meta: [
          { hid: 'description', name: 'description', content: 'Servicios de recubrimientos industriales para protección y mejora de propiedades de piezas y componentes.' }
        ]
      }
    }
