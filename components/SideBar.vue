<template>
  <div class="nav-menu" :class="{ 'active': isMenuOpen }">
    <nav class="nav-links">
      <NuxtLink to="/" class="nav-link" @click="handleLinkClick">
        <span class="nav-icon">
      ...
      <NuxtLink to="/servicios" class="nav-link" @click="handleLinkClick">
        <span class="nav-icon">
      ...
      <NuxtLink to="/catalogo" class="nav-link" @click="handleLinkClick">
        <span class="nav-icon">
      ...
      <NuxtLink to="/industrias" class="nav-link" @click="handleLinkClick">
        <span class="nav-icon">
      ...
      <NuxtLink to="/about" class="nav-link" @click="handleLinkClick">
        <span class="nav-icon">
      ...
      <NuxtLink to="/faqs" class="nav-link" @click="handleLinkClick">
        <span class="nav-icon">
      ...
      <NuxtLink to="/contact" class="nav-link" @click="handleLinkClick">
        <span class="nav-icon">
